...
--
-- Host: localhost:3306
-- Generation Time: Apr 09, 2018 at 12:57 PM
...
('Alicia Vikander', 29, '1988-10-03 00:00:00', 'Female', 'Alicia Vikander is a Swedish actress, dancer and producer. She was born and raised in Gothenburg, Västra Götalands län, Sweden, to Maria Fahl-Vikander, an actress of stage and screen, and Svante Vikander, a psychiatrist. She is of Swedish and one quarter Finnish descent.', 'http://celebmafia.com/wp-content/uploads/2017/07/alicia-vikander-bvlgari-puo-up-store-ribbon-cutting-at-the-galeries-lafayette-in-paris-07-04-2017-1.jpg'),
('Bella Thorne', 20, '1997-10-08 00:00:00', 'Female', 'Bella Thorne was born in Pembroke Pines, Florida, to Tamara (Beckett) and Delancey Reinaldo \"Rey\" Thorne. She has three siblings, Remy Thorne, Dani Thorne and Kaili Thorne, all of whom have also acted. She is of Cuban (father) and Irish, Italian, English, German, and Welsh (mother) ancestry.', 'https://upload.wikimedia.org/wikipedia/commons/2/23/Bella_Thorne_March_18%2C_2014_%28cropped%29.jpg'),
('Chadwick Boseman', 40, '1996-11-29 00:00:00', 'Male', 'Chadwick Boseman is an American actor. He is known for his portrayal of TChalla / Black Panther in the Marvel Cinematic Universe (since 2016), particular in Black Panther (2018), and for his starring roles in as Jackie Robinson in 42 (2013), James Brown in Get on Up (2014), and Thurgood Marshall in Marshall (2017).', 'http://photos.laineygossip.com/articles/chadwick-boseman-oscar-05mar18-01.jpg'),
('Dennis Quaid', 63, '1954-04-09 00:00:00', 'Male', 'Dennis Quaid was born in Houston, Texas, to Juanita Bonniedale (Jordan), a real estate agent, and William Rudy Quaid, an electrician. He grew up in the Houston suburban city of Bellaire. He was raised a Baptist, and studied drama, Mandarin Chinese, and dance while a student at Bellaire High School.', 'https://upload.wikimedia.org/wikipedia/commons/1/17/Dennis_Quaid_DN-SC-04-10040.JPEG'),
('Hugh Jackman', 49, '1968-10-12 00:00:00', 'Male', 'Hugh Michael Jackman is an Australian actor, singer, multi-instrumentalist, dancer and producer. Jackman has won international recognition for his roles in major films, notably as superhero, period, and romance characters. He is best known for his long-running role as Wolverine in the X-Men film series.', 'https://upload.wikimedia.org/wikipedia/commons/1/19/World_Premiere_Logan_Berlinale_2017.jpg'),
('Karen Gillan', 30, '1996-11-28 00:00:00', 'Female', 'Karen Sheila Gillan was born and raised in Inverness, Scotland, the daughter of Marie (Paterson) and John Gillan, who is a singer and recording artist. She developed a love for acting very early on, attending several youth theatre groups and taking part in a wide range of productions at her school, Charleston Academy.', 'http://www.hawtcelebs.com/wp-content/uploads/2017/04/karen-gillan-at-guardians-of-the-galaxy-vol.-2-premiere-in-hollywood-04-19-2017_1.jpg'),
('Matthew Goode', 39, '1996-04-03 00:00:00', 'Male', 'Matthew William Goode (born 3 April 1978) is an English actor. His films include Chasing Liberty (2004), Match Point (2005), Imagine Me and You (2006), Brideshead Revisited (2008), Watchmen (2009), A Single Man (2009), Leap Year (2010), Stoker (2013) and The Imitation Game (2014). ', 'https://upload.wikimedia.org/wikipedia/commons/e/ef/Matthew_Goode_2014.jpg'),
('Scarlett Johansson', 33, '1996-11-22 00:00:00', 'Female', 'Scarlett Johansson was born in New York City. Her mother, Melanie Sloan, is from a Jewish family from the Bronx, and her father, Karsten Johansson, is a Danish-born architect, from Copenhagen.', 'https://www.biography.com/.image/ar_1:1%2Cc_fill%2Ccs_srgb%2Cg_face%2Cq_80%2Cw_300/MTE4MDAzNDEwNzkxOTI1MjYy/scarlett-johansson-13671719-1-402.jpg'),
('Scott Eastwood', 32, '1986-03-21 00:00:00', 'Male', 'Scott Eastwood was born Scott Clinton Reeves in Carmel, Monterey County, California, to Jacelyn Ann Reeves, a flight attendant, and Clint Eastwood, an actor and director. He grew up in Hawaii. Scott has a younger sister, Kathryn Eastwood, and several half-siblings.', 'https://upload.wikimedia.org/wikipedia/commons/d/d2/Scott_Eastwood_52nd_Annual_Publicists_Awards_-_Feb_2015_%28cropped%29.jpg');
...
('9th of Mayo', '90 Taha Hussien St', 'Mayo Movies', 5, b'1', b'0', 'Rainassance', '', ''),
('Al Haram', '3rd Pyramids Square', 'Pharoahs Cinema', 4, b'1', b'0', 'Egyptian Producers', '', ''),
('Mokattam', '7071, Street 9', 'Cinema Mawlana', 5, b'1', b'0', 'Rainassance', '', ''),
('New Cairo', '70th Cairo Festival Square', 'Galaxy Cinema', 8, b'1', b'1', 'Galaxco', '', ''),
('New Cairo', '100 Street 90, 5th Settlement', 'Point 90', 3, b'1', b'1', 'Galaxco', '', ''),
('Old Cairo', '3 Metropolis, Street 30', 'El Zaaeem El Cinema', 5, b'0', b'0', 'Rainassance', '', '');
...
('Old Cairo', 'El Zaaeem El Cinema', 1, 'NORMAL', 2, 50, 28),
('New Cairo', 'Galaxy Cinema', 1, 'VIP', 3, 80, 5),
('9th of Mayo', 'Mayo Movies', 1, 'VIP', 4, 80, 5),
('Al Haram', 'Pharoahs Cinema', 1, 'VIP', 1, 100, 28),
('New Cairo', 'Point 90', 1, 'VIP', 2, 100, 3),
('Mokattam', 'Cinema Mawlana', 2, 'NORMAL', 3, 50, 4),
('Old Cairo', 'El Zaaeem El Cinema', 2, 'NORMAL', 4, 50, 5),
('New Cairo', 'Galaxy Cinema', 2, 'VIP', 1, 100, 26),
('9th of Mayo', 'Mayo Movies', 2, 'VIP', 2, 100, 26),
('Al Haram', 'Pharoahs Cinema', 2, 'VIP', 3, 80, 5),
('New Cairo', 'Point 90', 2, 'VIP', 4, 100, 26),
('Mokattam', 'Cinema Mawlana', 3, 'NORMAL', 2, 70, 14),
('Old Cairo', 'El Zaaeem El Cinema', 3, 'NORMAL', 1, 50, 4),
('New Cairo', 'Galaxy Cinema', 3, 'NORMAL', 4, 80, 2),
('9th of Mayo', 'Mayo Movies', 3, 'NORMAL', 3, 50, 13),
('Al Haram', 'Pharoahs Cinema', 3, 'NORMAL', 1, 50, 13),
('New Cairo', 'Point 90', 3, 'VIP', 2, 80, 5),
('Mokattam', 'Cinema Mawlana', 4, 'NORMAL', 1, 80, 28),
('Old Cairo', 'El Zaaeem El Cinema', 4, 'NORMAL', 1, 100, 3),
('New Cairo', 'Galaxy Cinema', 4, 'DELUXE', 3, 100, 3),
('9th of Mayo', 'Mayo Movies', 4, 'NORMAL', 2, 100, 3),
('Al Haram', 'Pharoahs Cinema', 4, 'NORMAL', 3, 50, 2),
('Mokattam', 'Cinema Mawlana', 5, 'VIP', 4, 100, 26),
...
INSERT INTO `promocodes` (`promocode`, `type`, `value`, `imagePath`) VALUES
